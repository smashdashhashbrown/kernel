...
static void *my_seq_start(struct seq_file *s, loff_t *pos) {
    ...
    // Is this safe? Understand the variable is static so will exist
 ...
 * It is called until the return is NULL (ends the sequence).
 */
static void *my_seq_next(struct seq_file *s, void *v, loff_t *pos) {
    // This is the counter passed from my_seq_start
